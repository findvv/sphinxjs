...
var PLUGIN_NAME = 'sm-sass';

var smSass = function smSass(options, sync) {
    return through.obj(function (file, enc, cb) {
        ...
        if (sync !== true) {
            ...
            smSass.compiler.render(opts, callback);
        } else {
            //////////////////////////////
            // Sync Sass render
            //////////////////////////////
            try {
                result = smSass.compiler.renderSync(opts);
...
// Sync Sass render
//////////////////////////////
smSass.sync = function sync(options) {
    return smSass(options, true);
};

//////////////////////////////
// Log errors nicely
//////////////////////////////
smSass.logError = function logError(error) {
...
//////////////////////////////
smSass.compiler = require('node-sass');

module.exports = smSass;